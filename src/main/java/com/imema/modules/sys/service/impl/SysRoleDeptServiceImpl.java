...
import com.imema.modules.sys.dao.SysRoleDeptDao;
...
public class SysRoleDeptServiceImpl extends BaseServiceImpl<SysRoleDeptDao, SysRoleDeptEntity> implements SysRoleDeptService {
	...
	public List<Long> queryDeptList(Long roleIds) {
		return baseMapper.queryDeptList(roleIds);
	}
