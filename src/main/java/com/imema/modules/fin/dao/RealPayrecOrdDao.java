 ...
 */
@Mapper
public interface RealPayrecOrdDao extends BaseMapper<RealPayrecOrdEntity> {

    IPage<RealPayrecOrdEntity> queryPage(IPage<RealPayrecOrdEntity> page, @Param("p") Map<String, Object> params);
